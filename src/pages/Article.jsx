        ...
        <div>
            ...
            <div className="bg-purple-800 title-page">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="pt-0 md:pt-52 pl-10 md:pl-28 pr-6 pb-16">
            ...
            {/* ADJUST WIDTH */}
            <div className="px-12 md:px-28 xl:px-30 2xl:px-60">

                {/* CONTENT */}
                <div className="py-10 grid grid-cols-1 md:grid-cols-3 gap-x-6">

                    {/* ARTICLE */}
                    <div className="col-span-2 text-md leading-relaxed text-justify article-content">
                    ...
                    {/* OTHER ARTICLE */}
                    <div className="px-10 text-md leading-relaxed text-justify">
                        <div>
