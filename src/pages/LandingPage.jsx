      ...
      <div>
        <div className="flex flex-row justify-between items-center gap-x-12">
          <div className="flex flex-col">
            ...
            <p className="pt-6 text-xl mr-8">
              ...
              clinically-backed digital tools for
              proactively improving mental wellbeing.
            </p>
        ...
        <div className="pt-60 flex flex-row justify-between items-center gap-x-12">
          <div className="flex flex-col">
            ...
            <p className="pt-6 text-xl mr-8">
              GoCure is a platform for helping our user to
              keep their mental health keep healthy and safe
              through our content
            </p>
          </div>
